...
// contact : https://www.linkedin.com/in/mehmet-akif-demirezen-396521128/
...
class CustomButton: UIButton {
    ...
    @IBInspectable var isBold: Bool = false {
        ...
        func doEnable() {
        self.isEnabled = true
        self.backgroundColor = ColorUtil.activaButton
    }
    func doDisable() {
        self.isEnabled = false
        self.backgroundColor = ColorUtil.passiveButton
